...
<div class="container-fluid p-0">
    <div class="row no-gutters">
        <section class="project-lists col-lg-12" data-type="qi">
            <div class="container-fluid p-0">
                <div class="row no-gutters">
                                ...
                                <div class="col-lg-12">
                                    <div class="project-filters d-flex">
                                        ...
                                        <div class="project-filters--item category--filter w-50">
                                            <label for="dropdown-category">I am interested in projects related to:</label>
                                            <select class="select-category" name="categories[]" multiple="multiple">
                                                <% loop $VisibleQIProjectCategories %>
