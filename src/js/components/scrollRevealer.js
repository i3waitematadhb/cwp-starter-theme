...
export default function () {
  ...
  (function() {
    ...
    // let imageOverlay = $('.section-ImageWithTextOverlay');
    // if(imageOverlay.length > 0) {
    //   imageOverlay.each(function () {
    //     let scrollElemToWatch = $(this).find('.imageWithTextOverlay-content');
    //     let watcher = scrollMonitor.create(scrollElemToWatch, -300)
    //     let image = new RevealFx(scrollElemToWatch, {
    //       revealSettings:  {
    //         bgColor: '#ff7b1e',
    //         direction: 'rl',
