...
export default function () {
  ...
  const body = $('.imageWithTextOverlay-content');//document.getElementsByClassName('.section-ImageWithTextOverlay');
  ...
  class SmoothScroll {
    constructor() {
      ...
      [...this.DOM.content.querySelectorAll('.section-ImageWithTextOverlay')].forEach(item => this.items.push(new Item(item)));
